...
import {GldasIdentifyTaskResults, GldasIdentifyTaskResultsByMonth} from '../../services/GLDAS/gldas';
...
const ChangeInStorageIndicator:React.FC<Props> = ({
    ...
    const getChangeInStorageValueIndicator = () => {
        ...
        const ratio = changeInStorageVal >- 0? (100 - (changeInStorageVal / max ) * 100) /2 : 100 - ( 100 - (Math.abs(changeInStorageVal / min)) * 100 ) / 2;
